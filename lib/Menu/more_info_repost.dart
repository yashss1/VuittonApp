...
class MoreInfoRepost extends StatefulWidget {
  const MoreInfoRepost({Key? key, required this.array, required this.index})
      : super(key: key);

  final array, index;

  @override
  _MoreInfoRepostState createState() => _MoreInfoRepostState();
}

class _MoreInfoRepostState extends State<MoreInfoRepost> {
  var arr, date, d12;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Instagram Handle: ${widget.array[widget.index]['InstaHandle']}\nURL: ${widget.array[widget.index]['URL']}\n",
                              style: TextStyle(
                                fontSize: 15,
                                fontFamily: 'Bizmo2',
