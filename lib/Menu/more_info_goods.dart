...
class MoreInfoGoods extends StatefulWidget {
  const MoreInfoGoods({Key? key, required this.array, required this.index})
      : super(key: key);

  final array, index;

  @override
  _MoreInfoGoodsState createState() => _MoreInfoGoodsState();
}

class _MoreInfoGoodsState extends State<MoreInfoGoods> {
  var arr, date, d12;

  @override
  void initState() {
    super.initState();
    if (widget.array[widget.index]['Update'] != null) {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Item: ${widget.array[widget.index]['ItemName']}\nSize: ${widget.array[widget.index]['Size']}\nBudget: \$${widget.array[widget.index]['Budget']}\n ",
                              style: TextStyle(
                                fontSize: 15,
                                fontFamily: 'Bizmo2',
