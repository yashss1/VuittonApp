...
class MoreInfoFlights extends StatefulWidget {
  const MoreInfoFlights({Key? key, required this.array, required this.index})
      : super(key: key);

  final array, index;

  @override
  _MoreInfoFlightsState createState() => _MoreInfoFlightsState();
}

class _MoreInfoFlightsState extends State<MoreInfoFlights> {
  var arr, date, d12;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Date: ${widget.array[widget.index]['Date']}\nTime: ${widget.array[widget.index]['time']}\n${widget.array[widget.index]['DepartureCode']} -> ${widget.array[widget.index]['ArrivalCode']}\nPassengers : ${widget.array[widget.index]['Passengers']}\n",
                              style: TextStyle(
                                fontSize: 15,
                                fontFamily: 'Bizmo2',
